...
export const TeamPage = ({ id, setActivePage }) => {
    ...
    return (
        id != null &&
        <div className="z-100 absolute top-0 bg-white w-full">
            <svg width="100%" height="95" viewBox="0 0 678 95" fill="none" xmlns="http://www.w3.org/2000/svg" className="absolute -top-8">
            ...
            <div className="container relative px-10 py-12 flex flex-col gap-[1.5rem]">
                <div className="flex items-center justify-start">
                    <button className="hover:-translate-x-1 transition-all" onClick={() => {setActivePage(null)}}>
                ...
                <div className="flex flex-col lg:flex-row gap-16">
                    <div className="flex flex-col items-center justify-center text-center gap-5">
                        <h1 className="text-[#00005A] font-bold italic text-6xl">{teamInfo.detailsPage.fullName}</h1>
                        <img 
                            src={teamInfo.detailsPage.carTeam} 
                            alt={`${teamInfo.name}'s car`} 
