...
export const AppLayout = ({ children }) => {
  ...
  return (
    <div className="px-[2em] sm:px-[0em] sm:pr-[2em] py-[2em] w-full h-full flex flex-col xl:flex-row justify-top items-center xl:justify-center xl:items-start relative xl:static">
